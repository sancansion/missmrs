...
<body>
	...
	<div id="wrapper">
		...
		<footer>
			<section>
				<article class="summary">
					<nav>
						<ul>
							...
							<li>
								<a href="http://missmrs.biz/recruit/">求人情報</a>
							</li>
							<li>
				...
				<p class="copyright">© 2016 Miss.Mrs All Rights Reserved.</p>
			</section>
		</footer>
		<!-- END: footer -->
	...
	<!-- Syntax Highlighter -->
	<script type="text/javascript" src="static_contents/js/shCore.js"></script>
	<script type="text/javascript" src="static_contents/js/shBrushXml.js"></script>
	<script type="text/javascript" src="static_contents/js/shBrushJScript.js"></script>
